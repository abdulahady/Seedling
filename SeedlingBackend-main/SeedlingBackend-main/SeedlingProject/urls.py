...
urlpatterns = [
    ...
    path("api/v3/", include("core.api.supabase_urls")),
...
if settings.ENABLE_LEGACY_WAGTAIL_API:
    # Keep legacy Wagtail endpoints during migration rollout.
    urlpatterns.insert(5, path("api/v2/", api_router.urls))
